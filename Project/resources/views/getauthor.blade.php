        ...
        <div class="col-xl-12 col-lg-12 col-12">
            <div class="card shopping-cart">
                <div class="card-header pb-2">
                    <h4 class="card-title mb-1">المؤلفون</h4>
                </div>
                <div class="card-content">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <form class="row2 row" method="POST" action="{{ route('storeAuther') }}">
                                @csrf
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">اسم المؤلف</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="row2 row" method="POST"
                                                    action="{{ route('editAuther', $row['ID']) }}">
                                                    @csrf
                                                    {{--  <div class="col-md-2">  --}}
                                            ...
                                            <td>
                                                <a href="{{ route('deleteAuther', $row['ID']) }}"><i
