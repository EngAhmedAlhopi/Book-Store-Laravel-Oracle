        ...
        <div class="col-xl-12 col-lg-12 col-12">
            <div class="card shopping-cart">
                <div class="card-header pb-2">
                    <h4 class="card-title mb-1">حالات العناوين</h4>
                </div>
                <div class="card-content">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <form class="row2 row" method="POST" action="{{ route('storeAddressStatus') }}">
                                @csrf
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">الحالة</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="row2 row" method="POST"
                                                    action="{{ route('editAddressStatus', $row['ID']) }}">
                                                    @csrf
                                                    {{--  <div class="col-md-2">  --}}
                                                    <input type="text" class="form-control inname"
                                                        id="validationCustom01" value="{{ $row['STATUS'] }}" name="name"
                                                        required>
                                                    {{--  </div>  --}}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('deleteAddressStatus', $row['ID']) }}"><i
