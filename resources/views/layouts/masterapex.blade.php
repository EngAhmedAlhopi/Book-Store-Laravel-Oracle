            ...
            <div class="navbar-header d-flex">
                ...
                <div class="navbar-brand-center">
                    <div class="navbar-header">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <div class="logo"><a class="logo-text" href="{{ route('indexAdmin') }}">
                                        <div class="logo-img"><img class="logo-img" alt="Apex logo"
                                                src="{{ asset('app-assets2/img/logo-dark.png') }}"></div><span
                                            class="text">اقرأ</span>
                                    </a></div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="navbar-nav">
                        {{--  <li class="i18n-dropdown dropdown nav-item mr-2"><a
                                ...
                                id="dropdown-flag" href="javascript:;" data-toggle="dropdown"><img
                                    class="langimg selected-flag" src="{{ asset('app-assets2/img/flags/us.png') }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-left" aria-labelledby="dropdown-flag">
                                <a class="dropdown-item" href="javascript:;" data-language="en">
                                    <img class="langimg mr-2" src="{{ asset('app-assets2/img/flags/us.png') }}"
                                        alt="flag"><span class="font-small-3">English</span></a><a
                                    class="dropdown-item" href="javascript:;" data-language="es"><img
                                        class="langimg mr-2" src="{{ asset('app-assets2/img/flags/es.png') }}"
                                        alt="flag"><span class="font-small-3">Spanish</span></a><a
                                    class="dropdown-item" href="javascript:;" data-language="pt"><img
                                        class="langimg mr-2" src="{{ asset('app-assets2/img/flags/pt.png') }}"
                                        alt="flag"><span class="font-small-3">Portuguese</span></a><a
                                    class="dropdown-item" href="javascript:;" data-language="de"><img
                                        class="langimg mr-2" src="{{ asset('app-assets2/img/flags/de.png') }}"
                                        alt="flag"><span class="font-small-3">German</span></a></div>
                        </li>  --}}
                        ...
                        <li class="dropdown nav-item mr-1"><a
                                ...
                                <div class="user d-md-flex d-none mr-2"><span
                                        class="text-right">{{ Session::get('fname') . ' ' . Session::get('lname') }}</span><span
                                        class="text-right text-muted font-small-3">متصل</span></div><img
                                    class="avatar" src="{{ asset('app-assets2/img/portrait/small/avatar-s-1.png') }}"
                            ...
                            <div class="dropdown-menu text-left dropdown-menu-right m-0 pb-0"
                                ...
                                <a class="dropdown-item" href="app-email.html">
                                    <div class="d-flex align-items-center"><i class="ft-mail mr-2"></i><span>صندوق
                                            الوارد</span></span></div>
                                </a>
